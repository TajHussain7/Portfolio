const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/tajhussain7",
      icon: (
    ...
    {
      name: "Email",
      url: "mailto:tajamaltajamal702@gamil.com",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-white">Tajamal Hussain</h3>
